...
```kotlin
String.eq()
// arrow.instances.StringKt$eq$1@2fb9fa70
```

```kotlin
Option.functor()
// arrow.core.Instance_arrow_instances_OptionFunctorInstanceKt$functor$1@76a300b
```

```kotlin
MapK.semigroup<String, Int>(Int.semigroup())
// arrow.data.Instance_arrow_instances_MapKSemigroupInstanceKt$semigroup$1@666c6b6f
```

```kotlin
Either.monadError<Throwable>()
// arrow.core.Instance_arrow_instances_EitherMonadErrorInstanceKt$monadError$1@4fcd440f
```

```kotlin
ListK.traverse()
// arrow.data.Instance_arrow_instances_ListKTraverseInstanceKt$traverse$1@55064b55
```
...
ListK.functor()
// arrow.data.Instance_arrow_instances_ListKFunctorInstanceKt$functor$1@35b1add8
```
